...
class OpentransDocumentAddress
{
    ...
    public function set_name($value)
    {
        ...
        if (!is_string($value)) {
            throw new OpentransException('$value must be string.');
        }
     ...
     *
     * @param object $product_id OpentransDocumentAddressContactDetails
     * @return void
     */
    public function set_contact_details($contact_details)
    {

        if (!$contact_details instanceof OpentransDocumentAddressContactDetails) {
            throw new OpentransException('$contact_details must be type of OpentransDocumentAddressContactDetails');
        }
    ...
    public function set_phone($value, $type = NULL)
    {
        ...
        if ($type !== NULL && !preg_match('/^\w{1,50}$/', $type)) {
            throw new OpentransException('Phone type must be string, 1 to 50 characters');
        }
