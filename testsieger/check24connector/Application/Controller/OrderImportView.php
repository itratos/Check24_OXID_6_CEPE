...
use TestSieger\Check24Connector\Application\Model\OpentransDocumentReaderOrder;
use TestSieger\Check24Connector\Application\Model\OpentransDocumentHeaderOrderinfo;
use TestSieger\Check24Connector\Application\Model\OpentransDocumentIdref;
use TestSieger\Check24Connector\Application\Model\OpentransDocumentWriterOrderchange;
use TestSieger\Check24Connector\Application\Model\OpentransDocumentWriterOrderresponse;
use TestSieger\Check24Connector\Application\Model\Process;
use TestSieger\Check24Connector\Application\Model\OpentransDocumentParty;
...
class OrderImportView extends \OxidEsales\Eshop\Application\Controller\FrontendController
{
    ...
    protected function process_xml_file($filename, $config)
    {
        ...
        if (!($opentrans_order instanceof \TestSieger\Check24Connector\Application\Model\OpentransDocumentOrder)) {
        ...
        if ($oOrder->load($order_oxid)) {
            if ($oOrder->validateImportedCheck24Order()) {
                ...
                $src = $oOrder->create_document_orderchange(
                    \TestSieger\Check24Connector\Application\Model\Order::ORDER_ITEM_CANCELLATION_REASONKEY_ORDER_INVALID,
                    \TestSieger\Check24Connector\Application\Model\Order::ORDER_ITEM_CANCELLATION_REASONDESC_ORDER_INVALID,
                    \TestSieger\Check24Connector\Application\Model\OpentransDocumentOrderchange::ORDERCHANGE_TYPE_ORDER_INVALID
                );
